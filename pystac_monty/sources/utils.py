...
class IDMCUtils:
    ...
    def hazard_codes_mapping(hazard: tuple) -> list[str]:
        ...
        hazard_mapping = {
            ...
            ("geophysical", "geophysical", "volcanic activity", "volcanic activity"): ["GH0201", "nat-geo-vol-vol", "VO"],
            ...
            ("weather related", "hydrological", "flood", "dam release flood"): ["TL0205", "tec-mis-col-col", "FL"],
